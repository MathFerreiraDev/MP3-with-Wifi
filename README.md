...
- O nome da faixa aparece em cima do "disco" e, se for muito grande pra caber na tela, ele fica em modo de letreiro (efeito marquee), avançando um caractere a cada ~300ms até dar a volta completa no nome e recomeçar.
